...
public abstract class Point2D implements Cloneable {
     ...
     * @return the square of the distance between this {@code Point2D} to a specified {@code
     *     Point2D}.
     * @since 1.2
     */
     ...
     * @return {@code true} if the object to be compared is an instance of {@code Point2D} and has
