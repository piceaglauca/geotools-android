 ...
 *
 * <p>Multiple subpaths can be expressed by using a "MOVETO" segment to create a discontinuity in
 * the geometry to move from the end of one subpath to the beginning of the next.
 *
 * <p>Each subpath can be closed manually by ending the last segment in the subpath on the same
